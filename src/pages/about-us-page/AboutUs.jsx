    ...
    <Layout2>
      <div className="sora1">
        <div className="text-container">
          <p style={{ fontFamily: "Josefin Sans", fontSize: "50px" }}>
            About us
          </p>
          <p className="stretch">
            We are a team passionate about cooking and all the cultural
            diversity that it can provide and be expressed through it. This love
            for sharing our experiences led us to create DishConnect, a great
            community for every person, with or without experience, to explore
            and contribute to this wonderful world of gastronomy.
          </p>
        </div>
      ...
      <div className="sora1">
        ...
        <div className="text-container2">
          ...
          <p className="stretch">
            ...
            explore and enjoy recipes from every corner of the planet, promoting
